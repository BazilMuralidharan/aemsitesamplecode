...
const idComRedirect = authModeParam && ((idComSuccess === 'true') && ((authModeParam === 'AadhaarOTP') || (authModeParam === 'DebitCard') || (authModeParam === 'CreditCard') || (authModeParam === 'NetBanking'))); // debit card or credit card or netbanking flow
